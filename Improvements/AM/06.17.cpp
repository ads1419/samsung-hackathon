...
void return_placeholders(string gram, string input_str, vector<string> v_c) {
	input_str += " ";
...
string give_command(string input_str) {
	...
	return_placeholders(ans, input_str, v_c);
...
int main() {
	...
	string input_str = "Can you book a flight ticket on 14 February from Bangalore to Ranchi ";
	...
	// for(my = concepts.begin(); my != concepts.end(); ++my) {
	// 	cout << my->first << endl;
	// 	print_vec(my -> second);
	// }
	// map<string, int>::iterator it;
