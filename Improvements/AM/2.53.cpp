...
int main() {
	...
	string input_str = "I want you to make tomorrow 9 O clock morning event ";
	...
	cout << give_command(input_str) << endl;

	// map<string, vector<string> > :: iterator my;
	// for(my = placeholder.begin(); my != placeholder.end(); ++my) {
	// 	cout << my->first << endl;
	// 	print_vec(my -> second);
	// }
	// map<string, int>::iterator it;
	...
	// }
	// cout << "***";
	// map<string, vector<string> >::iterator itrr;
	// string s;
	// for(itrr = grammar_words.begin(); itrr != grammar_words.end(); ++itrr) {
	// 	cout << itrr->first << "\t";
	// 	print_vec(itrr -> second);
	// 	cout << endl << endl;
	// }
	// cout << "***";
